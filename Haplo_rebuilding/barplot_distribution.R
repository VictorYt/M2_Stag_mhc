...
#GvH_distribution
pdf("Distribution_of_error_between_G&H.pdf", height = 10, width = 10)
ggplot(data = distri, aes(x=Number_of_error, y=Number_of_error_occurency)) +
  ...
  ggtitle("Distribution of the number of error in the comparison between the genotypes and the haplotypes") +
  theme_gray()
...
#HvH_distribution
pdf("Distribution_of_error_between_H&H.pdf", height = 10, width = 10)
ggplot(data = distri_haplo, aes(x=Number_of_error, y=Number_of_error_occurency)) +
  ...
  ggtitle("Distribution of the number of error in the comparison between the the haplotypes") +
  theme_gray()
