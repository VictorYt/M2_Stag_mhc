...
if __name__ == "__main__" :
	...
	arguments = docopt(__doc__, version="Convertiseur_map/ped_to_HR 0.1")
	print (arguments)
	...
	def body_line_maker(ped_f):
		"""Return the body line to write in my output
